...
instruction) advances a live Flow across multiple scheduled wakes. Spec 2, not yet
written — Spec 1 (Goal 1) must exist first since it's Spec 2's dependency.
**Status:** todo
**Sub-goals:**
- [ ] **2a** Brainstorm + write the Spec 2 design doc (tick-prompt skill content, and
  ...
  _accept:_ spec committed, same self-review bar as Spec 1.
